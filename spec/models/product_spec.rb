...
RSpec.describe Product, type: :model do
  describe 'Validations' do
    ...
    it 'Should throw error if name is not present' do
      ...
      @product.save
      expect(@product.errors.full_messages.include?("Name can't be blank")).to be_present
    end
    ...
    it 'Should throw error if price is not present' do
      ...
      @product.save
      expect(@product.errors.full_messages.include?("Price can't be blank")).to be_present
    end
    ...
    it 'Should throw error if quantity is not present' do
      ...
      @product.save
      expect(@product.errors.full_messages.include?("Quantity can't be blank")).to be_present
    end
    ...
    it 'Should throw error if category is not present' do
      ...
      @product.save
      expect(@product.errors.full_messages.include?("Category can't be blank")).to be_present
    end
  end
end
